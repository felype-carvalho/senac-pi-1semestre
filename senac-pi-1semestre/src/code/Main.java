...
public class Main {
	...
	static String enigmas[] = new String[3];
	static String enigmaCorreto[] = new String[3];
	static String enigmaErrado[] = new String[3];
	static String enigmaResposta[] = new String[3];
...
//		System.out.println("\n");
//		
		digita("Espero que esteja ansioso para um projeto ultrassecreto, com o objetivo de tentar quebrar o indecifrável \n"
...
//			}
			...
			if (i == 3 || i == 6 || i == 9) {
				...
				System.out.println("\n");
				aux3 = enigmas[i];
				digita(aux3, milisPorChar);

				respostaEnigma = entrada.next();
				String aux4 = "";

				if (respostaEnigma == enigmaResposta[i]) {
					aux4 = enigmaCorreto[i];
					digita(aux4, milisPorChar);
					contEnigma++;
				} else {
					aux4 = enigmaErrado[i];
					digita(aux4, milisPorChar);
		...
		finalJogo(contPontos, contEnigma);
	}
